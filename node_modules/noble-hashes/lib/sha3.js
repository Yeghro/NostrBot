...
class Keccak extends utils_1.Hash {
    ...
    constructor(blockLen, suffix, outputLen, rounds = 24) {
        super();
    ...
    _cloneInto(to) {
        ...
        to || (to = new Keccak(blockLen, suffix, outputLen, rounds));
        to.state.set(state);
        to.pos = pos;
...
const genShake = (suffix, blockLen, outputLen) => (0, utils_1.wrapConstructorWithOpts)((opts = {}) => new Keccak(blockLen, suffix, opts.dkLen !== undefined ? opts.dkLen : outputLen));
